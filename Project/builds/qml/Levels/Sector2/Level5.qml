...
BaseLevel {
    ...
    totalSpawns: 1
      ...
      Image {
          id: background
          source: "../../../assets/Sectors/Sector2/Background.png"
          anchors.fill: parent
          z: 6
      }
      ...
      function spawnEnemy() {
          if(currentSpawns < totalSpawns) {
              var newEntityProperties = {
                ...
                entityManager.createEntityFromUrlWithProperties( Qt.resolvedUrl("../../Enemy/Sector2/Boss1.qml"), newEntityProperties  );
